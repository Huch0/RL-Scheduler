...
def compare_pdr_model(pdrs, pdr_envs, model, model_envs, deterministic=False, sample_times=100, log_dir='./experiments/tmp/1', verbose=False):
    """
...
def eval_model(model, envs, writer, deterministic=False, sample_times=100, verbose=False, render=False):
    if verbose:
...
if __name__ == "__main__":
    ...
    #         repeats[i][j] = [repeats[i][j], 1]

    repeats = repeats_12_100
    ...
    log_dir = './experiments/tmp/Env4/gamma_1/obs_v4/clip_1/custom_lr_exp/_18000000'
    model_path = 'MP_Single_Env4_gamma_1_obs_v4_clip_1_lr_custom_expv1_18000000'
    params = {
        "policy_kwargs": dict(
            net_arch=dict(
