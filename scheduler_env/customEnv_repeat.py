...
class SchedulingEnv(gym.Env):
    ...
    def __init__(self, machine_config_path="instances/Machines/v0-2.json", job_config_path="instances/Jobs/v0-3x3-deadline.json", render_mode="seaborn", weight_final_time=80, weight_job_deadline=20, weight_op_rate=0, target_time = 1000, max_repeat = 3):
        ...
        self.custom_scheduler = customRepeatableScheduler(jobs = self.jobs, machines= self.machine_config)
