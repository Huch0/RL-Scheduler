    ...
    def render(self, mode="seaborn", num_steps=0):
        ...
        for i in range(len(self.machines)):
            ...
            for index, operation in machine_operations.iterrows():
                ...
                shade_factor = (job_index + 1) / (len(self.jobs[0])) + 0.45
                ...
                operation_info = ' -> '.join(map(lambda x: str(x + 1), operation_sequences['machine'].tolist()))
                ...
                op_block = mpatches.Rectangle(
                    (operation["start"] // 100, i - 0.5), (operation["finish"] - operation["start"]) // 100, 1, facecolor=shaded_color, edgecolor='black', linewidth=1)
